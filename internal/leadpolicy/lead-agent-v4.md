...
- New leads default to `gpt-6-sol` with `medium` reasoning. The operator may select any model currently available from Codex without changing the lead's topic, thread, Project, history, or authority.
